...
export class Links extends ClientSDK {
    ...
    async list(
        ...
        return unwrapResultIterator(linksList(this, request, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(linksCreate(this, request, options));
    }
    ...
    async count(
        ...
        return unwrapAsync(linksCount(this, request, options));
    }
    ...
    async get(
        ...
        return unwrapAsync(linksGet(this, request, options));
    }
    ...
    async delete(
        ...
        return unwrapAsync(linksDelete(this, linkId, options));
    }
    ...
    async update(
        ...
        return unwrapAsync(linksUpdate(this, linkId, requestBody, options));
    }
    ...
    async updateMany(
        ...
        return unwrapAsync(linksUpdateMany(this, request, options));
    }
    ...
    async upsert(
        ...
        return unwrapAsync(linksUpsert(this, request, options));
    }
}
