...
/** @internal */
export const AnalyticsCitiesCountry$inboundSchema: z.ZodNativeEnum<typeof AnalyticsCitiesCountry> =
    z.nativeEnum(AnalyticsCitiesCountry);

/** @internal */
export const AnalyticsCitiesCountry$outboundSchema: z.ZodNativeEnum<typeof AnalyticsCitiesCountry> =
...
/** @internal */
export const AnalyticsCities$inboundSchema: z.ZodType<AnalyticsCities, z.ZodTypeDef, unknown> =
    z.object({
        city: z.string(),
