...
/** @internal */
export const LinkSchema$inboundSchema: z.ZodType<LinkSchema, z.ZodTypeDef, unknown> = z
    .object({
        id: z.string(),
        domain: z.string(),
        key: z.string(),
...
/** @internal */
export const LinkSchema$outboundSchema: z.ZodType<LinkSchema$Outbound, z.ZodTypeDef, LinkSchema> = z
    .object({
        id: z.string(),
        domain: z.string(),
        key: z.string(),
