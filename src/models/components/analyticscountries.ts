...
/** @internal */
export const City$inboundSchema: z.ZodNativeEnum<typeof City> = z.nativeEnum(City);

/** @internal */
export const City$outboundSchema: z.ZodNativeEnum<typeof City> = City$inboundSchema;
