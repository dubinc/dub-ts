...
export namespace LinkGeoTargeting$ {
    export const inboundSchema: z.ZodType<LinkGeoTargeting, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, LinkGeoTargeting> = z
        .object({
            af: z.string().optional(),
            al: z.string().optional(),
            dz: z.string().optional(),
