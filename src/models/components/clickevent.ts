...
/** @internal */
export const ClickEventGeo$inboundSchema: z.ZodType<
  ClickEventGeo,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type ClickEventGeo$Outbound = {
  AF?: string | undefined;
  AL?: string | undefined;
  DZ?: string | undefined;
  AS?: string | undefined;
...
/** @internal */
export const ClickEventGeo$outboundSchema: z.ZodType<
  ClickEventGeo$Outbound,
  z.ZodTypeDef,
  ClickEventGeo
> = z.object({
  af: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ClickEventGeo$ {
  /** @deprecated use `ClickEventGeo$inboundSchema` instead. */
  export const inboundSchema = ClickEventGeo$inboundSchema;
  /** @deprecated use `ClickEventGeo$outboundSchema` instead. */
  export const outboundSchema = ClickEventGeo$outboundSchema;
  /** @deprecated use `ClickEventGeo$Outbound` instead. */
