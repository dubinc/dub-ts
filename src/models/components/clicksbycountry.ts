...
/** @internal */
export namespace ClicksByCountry$ {
    export const inboundSchema: z.ZodType<ClicksByCountry, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ClicksByCountry> = z
        .object({
