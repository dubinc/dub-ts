 ...
 */
export const GetTopLinksByClicksDeprecatedQueryParamInterval = {
    Oneh: "1h",
    TwentyFourh: "24h",
    Sevend: "7d",
    Thirtyd: "30d",
 ...
 * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
 */
export type GetTopLinksByClicksDeprecatedQueryParamInterval = ClosedEnum<
    typeof GetTopLinksByClicksDeprecatedQueryParamInterval
>;

/**
 * The country to retrieve analytics for.
 */
export const GetTopLinksByClicksDeprecatedQueryParamCountry = {
    Af: "AF",
    Al: "AL",
    Dz: "DZ",
    As: "AS",
 ...
 * The country to retrieve analytics for.
 */
export type GetTopLinksByClicksDeprecatedQueryParamCountry = ClosedEnum<
...
export type GetTopLinksByClicksDeprecatedRequest = {
     ...
     * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
     */
    interval?: GetTopLinksByClicksDeprecatedQueryParamInterval | undefined;
    /**
     ...
     * The country to retrieve analytics for.
     */
    country?: GetTopLinksByClicksDeprecatedQueryParamCountry | undefined;
    /**
...
export type GetTopLinksByClicksDeprecatedResponseBody = {
    /**
...
/** @internal */
export namespace GetTopLinksByClicksDeprecatedQueryParamCountry$ {
    export const inboundSchema = z.nativeEnum(GetTopLinksByClicksDeprecatedQueryParamCountry);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace GetTopLinksByClicksDeprecatedRequest$ {
    ...
    > = z
        .object({
            ...
            country: GetTopLinksByClicksDeprecatedQueryParamCountry$.inboundSchema.optional(),
    ...
    > = z
        .object({
            ...
            country: GetTopLinksByClicksDeprecatedQueryParamCountry$.outboundSchema.optional(),
            city: z.string().optional(),
            device: z.string().optional(),
            browser: z.string().optional(),
            os: z.string().optional(),
...
/** @internal */
export namespace GetTopLinksByClicksDeprecatedResponseBody$ {
    export const inboundSchema: z.ZodType<
