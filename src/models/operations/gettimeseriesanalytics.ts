 ...
 * The country to retrieve analytics for.
 */
export type QueryParamCountry = (typeof QueryParamCountry)[keyof typeof QueryParamCountry];
...
/** @internal */
export const QueryParamInterval$: z.ZodNativeEnum<typeof QueryParamInterval> =
    z.nativeEnum(QueryParamInterval);

/** @internal */
export const QueryParamCountry$: z.ZodNativeEnum<typeof QueryParamCountry> =
    z.nativeEnum(QueryParamCountry);
...
export namespace GetTimeseriesAnalyticsResponse$ {
    ...
    export const inboundSchema: z.ZodType<GetTimeseriesAnalyticsResponse, z.ZodTypeDef, Inbound> =
        z.union([
