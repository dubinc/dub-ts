 ...
 */
export const GetClicksCountDeprecatedQueryParamInterval = {
    Oneh: "1h",
    TwentyFourh: "24h",
    Sevend: "7d",
    Thirtyd: "30d",
 ...
 * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
 */
export type GetClicksCountDeprecatedQueryParamInterval = ClosedEnum<
    typeof GetClicksCountDeprecatedQueryParamInterval
>;

/**
 * The country to retrieve analytics for.
 */
export const GetClicksCountDeprecatedQueryParamCountry = {
    Af: "AF",
    Al: "AL",
    Dz: "DZ",
    As: "AS",
 ...
 * The country to retrieve analytics for.
 */
export type GetClicksCountDeprecatedQueryParamCountry = ClosedEnum<
    typeof GetClicksCountDeprecatedQueryParamCountry
>;

export type GetClicksCountDeprecatedRequest = {
    /**
     ...
     * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
     */
    interval?: GetClicksCountDeprecatedQueryParamInterval | undefined;
    /**
     ...
     * The country to retrieve analytics for.
     */
    country?: GetClicksCountDeprecatedQueryParamCountry | undefined;
    /**
...
/** @internal */
export namespace GetClicksCountDeprecatedQueryParamCountry$ {
    export const inboundSchema = z.nativeEnum(GetClicksCountDeprecatedQueryParamCountry);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace GetClicksCountDeprecatedRequest$ {
    export const inboundSchema: z.ZodType<GetClicksCountDeprecatedRequest, z.ZodTypeDef, unknown> =
        z
            .object({
                ...
                country: GetClicksCountDeprecatedQueryParamCountry$.inboundSchema.optional(),
    ...
    > = z
        .object({
            ...
            country: GetClicksCountDeprecatedQueryParamCountry$.outboundSchema.optional(),
            city: z.string().optional(),
            device: z.string().optional(),
            browser: z.string().optional(),
            os: z.string().optional(),
