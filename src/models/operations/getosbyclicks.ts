 ...
 */
export const GetOSByClicksQueryParamInterval = {
    Oneh: "1h",
    TwentyFourh: "24h",
    Sevend: "7d",
    Thirtyd: "30d",
...
export type GetOSByClicksRequest = {
     ...
     * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
     */
    interval?: GetOSByClicksQueryParamInterval | undefined;
    /**
...
export type GetOSByClicksResponseBody = {
    /**
     * The name of the OS
     */
    os: string;
...
export namespace GetOSByClicksRequest$ {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetOSByClicksRequest> = z
        .object({
            domain: z.string().optional(),
            key: z.string().optional(),
            linkId: z.string().optional(),
...
/** @internal */
export namespace GetOSByClicksResponseBody$ {
    export const inboundSchema: z.ZodType<GetOSByClicksResponseBody, z.ZodTypeDef, unknown> = z
        .object({
            os: z.string(),
            clicks: z.number(),
        })
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetOSByClicksResponseBody> = z
        .object({
            os: z.string(),
            clicks: z.number(),
        })
