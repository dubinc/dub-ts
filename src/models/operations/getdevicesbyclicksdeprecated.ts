 ...
 */
export const GetDevicesByClicksDeprecatedQueryParamInterval = {
    Oneh: "1h",
    TwentyFourh: "24h",
    Sevend: "7d",
    Thirtyd: "30d",
 ...
 * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
 */
export type GetDevicesByClicksDeprecatedQueryParamInterval = ClosedEnum<
    typeof GetDevicesByClicksDeprecatedQueryParamInterval
>;

/**
 * The country to retrieve analytics for.
 */
export const GetDevicesByClicksDeprecatedQueryParamCountry = {
    Af: "AF",
    Al: "AL",
    Dz: "DZ",
    As: "AS",
 ...
 * The country to retrieve analytics for.
 */
export type GetDevicesByClicksDeprecatedQueryParamCountry = ClosedEnum<
    typeof GetDevicesByClicksDeprecatedQueryParamCountry
>;

export type GetDevicesByClicksDeprecatedRequest = {
    /**
     ...
     * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
     */
    interval?: GetDevicesByClicksDeprecatedQueryParamInterval | undefined;
    /**
     ...
     * The country to retrieve analytics for.
     */
    country?: GetDevicesByClicksDeprecatedQueryParamCountry | undefined;
    /**
...
export type GetDevicesByClicksDeprecatedResponseBody = {
    /**
...
/** @internal */
export namespace GetDevicesByClicksDeprecatedQueryParamCountry$ {
    export const inboundSchema = z.nativeEnum(GetDevicesByClicksDeprecatedQueryParamCountry);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace GetDevicesByClicksDeprecatedRequest$ {
    ...
    > = z
        .object({
            ...
            country: GetDevicesByClicksDeprecatedQueryParamCountry$.inboundSchema.optional(),
    ...
    > = z
        .object({
            ...
            country: GetDevicesByClicksDeprecatedQueryParamCountry$.outboundSchema.optional(),
            city: z.string().optional(),
            device: z.string().optional(),
            browser: z.string().optional(),
            os: z.string().optional(),
...
/** @internal */
export namespace GetDevicesByClicksDeprecatedResponseBody$ {
    export const inboundSchema: z.ZodType<
