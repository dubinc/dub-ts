 ...
 */
export const GetTopURLsByClicksDeprecatedQueryParamInterval = {
    Oneh: "1h",
    TwentyFourh: "24h",
    Sevend: "7d",
    Thirtyd: "30d",
 ...
 * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
 */
export type GetTopURLsByClicksDeprecatedQueryParamInterval = ClosedEnum<
    typeof GetTopURLsByClicksDeprecatedQueryParamInterval
>;

/**
 * The country to retrieve analytics for.
 */
export const GetTopURLsByClicksDeprecatedQueryParamCountry = {
    Af: "AF",
    Al: "AL",
    Dz: "DZ",
    As: "AS",
 ...
 * The country to retrieve analytics for.
 */
export type GetTopURLsByClicksDeprecatedQueryParamCountry = ClosedEnum<
    typeof GetTopURLsByClicksDeprecatedQueryParamCountry
>;

export type GetTopURLsByClicksDeprecatedRequest = {
    /**
     ...
     * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
     */
    interval?: GetTopURLsByClicksDeprecatedQueryParamInterval | undefined;
    /**
     ...
     * The country to retrieve analytics for.
     */
    country?: GetTopURLsByClicksDeprecatedQueryParamCountry | undefined;
    /**
...
export type GetTopURLsByClicksDeprecatedResponseBody = {
    /**
     * The destination URL
     */
    url: string;
...
/** @internal */
export namespace GetTopURLsByClicksDeprecatedQueryParamCountry$ {
    export const inboundSchema = z.nativeEnum(GetTopURLsByClicksDeprecatedQueryParamCountry);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace GetTopURLsByClicksDeprecatedRequest$ {
    ...
    > = z
        .object({
            ...
            country: GetTopURLsByClicksDeprecatedQueryParamCountry$.inboundSchema.optional(),
    ...
    > = z
        .object({
            ...
            country: GetTopURLsByClicksDeprecatedQueryParamCountry$.outboundSchema.optional(),
            city: z.string().optional(),
            device: z.string().optional(),
            browser: z.string().optional(),
            os: z.string().optional(),
...
/** @internal */
export namespace GetTopURLsByClicksDeprecatedResponseBody$ {
    export const inboundSchema: z.ZodType<
