...
export type GetClicksCountRequest = {
    /**
...
/** @internal */
export namespace GetClicksCountRequest$ {
    export const inboundSchema: z.ZodType<GetClicksCountRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetClicksCountRequest> = z
        .object({
            domain: z.string().optional(),
            key: z.string().optional(),
            linkId: z.string().optional(),
