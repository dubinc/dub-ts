 ...
 */
export const GetBrowsersByClicksDeprecatedQueryParamInterval = {
    Oneh: "1h",
    TwentyFourh: "24h",
    Sevend: "7d",
    Thirtyd: "30d",
 ...
 * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
 */
export type GetBrowsersByClicksDeprecatedQueryParamInterval = ClosedEnum<
    typeof GetBrowsersByClicksDeprecatedQueryParamInterval
>;

/**
 * The country to retrieve analytics for.
 */
export const GetBrowsersByClicksDeprecatedQueryParamCountry = {
    Af: "AF",
    Al: "AL",
    Dz: "DZ",
    As: "AS",
 ...
 * The country to retrieve analytics for.
 */
export type GetBrowsersByClicksDeprecatedQueryParamCountry = ClosedEnum<
    typeof GetBrowsersByClicksDeprecatedQueryParamCountry
>;

export type GetBrowsersByClicksDeprecatedRequest = {
    /**
     ...
     * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
     */
    interval?: GetBrowsersByClicksDeprecatedQueryParamInterval | undefined;
    /**
     ...
     * The country to retrieve analytics for.
     */
    country?: GetBrowsersByClicksDeprecatedQueryParamCountry | undefined;
    /**
...
export type GetBrowsersByClicksDeprecatedResponseBody = {
    /**
...
/** @internal */
export namespace GetBrowsersByClicksDeprecatedQueryParamCountry$ {
    export const inboundSchema = z.nativeEnum(GetBrowsersByClicksDeprecatedQueryParamCountry);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace GetBrowsersByClicksDeprecatedRequest$ {
    ...
    > = z
        .object({
            ...
            country: GetBrowsersByClicksDeprecatedQueryParamCountry$.inboundSchema.optional(),
    ...
    > = z
        .object({
            ...
            country: GetBrowsersByClicksDeprecatedQueryParamCountry$.outboundSchema.optional(),
            city: z.string().optional(),
            device: z.string().optional(),
            browser: z.string().optional(),
            os: z.string().optional(),
...
/** @internal */
export namespace GetBrowsersByClicksDeprecatedResponseBody$ {
    export const inboundSchema: z.ZodType<
