 ...
 */
export const GetCitiesByClicksQueryParamInterval = {
    Oneh: "1h",
    TwentyFourh: "24h",
    Sevend: "7d",
    Thirtyd: "30d",
 ...
 * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
 */
export type GetCitiesByClicksQueryParamInterval = ClosedEnum<
...
export type GetCitiesByClicksRequest = {
     ...
     * The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h.
     */
    interval?: GetCitiesByClicksQueryParamInterval | undefined;
    /**
     ...
     * The country to retrieve analytics for.
     */
    country?: GetCitiesByClicksQueryParamCountry | undefined;
    /**
...
export namespace GetCitiesByClicksRequest$ {
    export const inboundSchema: z.ZodType<GetCitiesByClicksRequest, z.ZodTypeDef, unknown> = z
        .object({
            ...
            country: GetCitiesByClicksQueryParamCountry$.inboundSchema.optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCitiesByClicksRequest> = z
        .object({
            domain: z.string().optional(),
            key: z.string().optional(),
            linkId: z.string().optional(),
            ...
            country: GetCitiesByClicksQueryParamCountry$.outboundSchema.optional(),
            city: z.string().optional(),
            device: z.string().optional(),
            browser: z.string().optional(),
            os: z.string().optional(),
