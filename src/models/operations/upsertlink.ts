...
export type UpsertLinkRequestBody = {
     ...
     * Geo targeting information for the short link in JSON format `{[COUNTRY]: https://example.com }`.
     */
    geo?: UpsertLinkGeo | null | undefined;
};
...
export namespace UpsertLinkGeo$ {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpsertLinkGeo> = z
        .object({
            af: z.string().optional(),
            al: z.string().optional(),
            dz: z.string().optional(),
...
export namespace UpsertLinkRequestBody$ {
    ...
    export const inboundSchema: z.ZodType<UpsertLinkRequestBody, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            geo: z.nullable(z.lazy(() => UpsertLinkGeo$.inboundSchema)).optional(),
        })
        .transform((v) => {
            return {
                url: v.url,
    ...
    export type Outbound = {
        ...
        ios?: string | null | undefined;
        android?: string | null | undefined;
        geo?: UpsertLinkGeo$.Outbound | null | undefined;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpsertLinkRequestBody> = z
        .object({
            ...
            ios: z.nullable(z.string()).optional(),
            android: z.nullable(z.string()).optional(),
            geo: z.nullable(z.lazy(() => UpsertLinkGeo$.outboundSchema)).optional(),
        })
        .transform((v) => {
            return {
                url: v.url,
