 ...
 */
export const GetDeviceAnalyticsQueryParamCountry = {
    Af: "AF",
    Al: "AL",
    Dz: "DZ",
    As: "AS",
 ...
 * The country to retrieve analytics for.
 */
export type GetDeviceAnalyticsQueryParamCountry =
    (typeof GetDeviceAnalyticsQueryParamCountry)[keyof typeof GetDeviceAnalyticsQueryParamCountry];
...
> = z.nativeEnum(GetDeviceAnalyticsQueryParamInterval);

/** @internal */
export const GetDeviceAnalyticsQueryParamCountry$: z.ZodNativeEnum<
    typeof GetDeviceAnalyticsQueryParamCountry
> = z.nativeEnum(GetDeviceAnalyticsQueryParamCountry);
