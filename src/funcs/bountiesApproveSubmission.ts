 ...
 */
export function bountiesApproveSubmission(
  client: DubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ApproveBountySubmissionRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ApproveBountySubmissionResponseBody$inboundSchema),
