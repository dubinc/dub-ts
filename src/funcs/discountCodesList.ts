...
export function discountCodesList(
  ...
  Result<
    Array<components.DiscountCodeSchema>,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.Forbidden
    | errors.NotFound
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListDiscountCodesRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(components.DiscountCodeSchema$inboundSchema)),
