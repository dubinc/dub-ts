...
export function partnersList(
  ...
  Result<
    Array<operations.ListPartnersResponseBody>,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.Forbidden
    | errors.NotFound
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListPartnersRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(operations.ListPartnersResponseBody$inboundSchema)),
