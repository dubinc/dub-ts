...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListFoldersRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.FolderSchema$inboundSchema)),
