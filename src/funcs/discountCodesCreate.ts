 ...
 */
export function discountCodesCreate(
  client: DubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateDiscountCodeRequestBody$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.DiscountCodeSchema$inboundSchema),
