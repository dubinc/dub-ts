 ...
 */
export function commissionsUpdateMany(
  client: DubCore,
  request?: operations.BulkUpdateCommissionsRequestBody | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.BulkUpdateCommissionsResponseBody>,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.Forbidden
    | errors.NotFound
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkUpdateCommissionsRequestBody$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/commissions/bulk")();
  ...
  >(
    M.json(
      200,
      z.array(operations.BulkUpdateCommissionsResponseBody$inboundSchema),
    ),
