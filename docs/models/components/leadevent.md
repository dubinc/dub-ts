...
let value: LeadEvent = {
  ...
  click: {
    ...
    browser: "Safari",
    os: "Linux",
    referer: "gaseous-scratch.net",
    refererUrl: "https://same-hello.com",
    ip: "130.21.13.247",
  },
  link: {
    id: "<id>",
    domain: "tired-circumference.com",
    key: "<key>",
  ...
  customer: {
    ...
    avatar: "https://picsum.photos/seed/YYZ7WfsK/680/594",
  },
  clickId: "<id>",
  linkId: "<id>",
  domain: "doting-mentor.biz",
  key: "<key>",
