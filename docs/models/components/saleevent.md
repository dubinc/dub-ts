...
let value: SaleEvent = {
  ...
  link: {
    id: "<id>",
    domain: "bare-foodstuffs.org",
    key: "<key>",
    url: "https://profitable-polarisation.com",
    externalId: "<id>",
    identifier: "<value>",
    expiresAt: "<value>",
    expiredUrl: "https://negative-fledgling.com",
    password: "6CJYe9gjjrevXXg",
    title: "<value>",
    description:
      "tomatillo disloyal jovially cleverly wrong abnegate convection bogus till",
    image: "https://loremflickr.com/1881/3838?lock=6873756113213840",
    video: "https://loremflickr.com/3480/2248?lock=5369952104718174",
    ios: "<value>",
    android: "<id>",
    geo: {},
    tagId: "<id>",
    ...
    comments:
      "save above hourly symbolise what likewise whether whereas collectivization despite till crumble besides",
    shortLink: "https://which-crocodile.net",
    qrCode: "https://unhappy-collaboration.name/",
    utmSource: "<value>",
    utmMedium: "<value>",
    utmCampaign: "<value>",
    utmTerm: "<value>",
  ...
  click: {
    ...
    browser: "Chrome",
    os: "MacOS",
    referer: "intrepid-fax.com",
    refererUrl: "https://some-makeover.org",
    ip: "196.68.94.56",
  },
  customer: {
    id: "<id>",
  ...
  clickId: "<id>",
  linkId: "<id>",
  domain: "quintessential-bakeware.net",
  key: "<key>",
