...
import { partnersList } from "dub/funcs/partnersList.js";
...
async function run() {
  const res = await partnersList(dub);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("partnersList failed:", res.error);
  }
}
...
**Promise\<[operations.ListPartnersResponseBody[]](../../models/.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="retrievePartnerLinks" method="get" path="/partners/links" -->
```typescript
import { Dub } from "dub";
...
```typescript
import { DubCore } from "dub/core.js";
import { partnersRetrieveLinks } from "dub/funcs/partnersRetrieveLinks.js";
...
**Promise\<[operations.RetrievePartnerLinksResponseBody[]](../../models/.md)\>**
...
```typescript
import { DubCore } from "dub/core.js";
import { partnersUpsertLink } from "dub/funcs/partnersUpsertLink.js";
...
```typescript
import { DubCore } from "dub/core.js";
import { partnersAnalytics } from "dub/funcs/partnersAnalytics.js";
...
<!-- UsageSnippet language="typescript" operationID="banPartner" method="post" path="/partners/ban" -->
```typescript
import { Dub } from "dub";
...
```typescript
import { DubCore } from "dub/core.js";
import { partnersBan } from "dub/funcs/partnersBan.js";
...
async function run() {
  const res = await partnersBan(dub);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("partnersBan failed:", res.error);
  }
}
...
**Promise\<[operations.BanPartnerResponseBody](../../models/operations/banpartnerresponsebody.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="deactivatePartner" method="post" path="/partners/deactivate" -->
```typescript
import { Dub } from "dub";
...
```typescript
import { DubCore } from "dub/core.js";
import { partnersDeactivate } from "dub/funcs/partnersDeactivate.js";
...
async function run() {
  const res = await partnersDeactivate(dub);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("partnersDeactivate failed:", res.error);
  }
}
...
**Promise\<[operations.DeactivatePartnerResponseBody](../../models/operations/deactivatepartnerresponsebody.md)\>**
