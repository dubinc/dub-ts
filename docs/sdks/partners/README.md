...
```typescript
import { DubCore } from "dub/core.js";
import { partnersUpdateSale } from "dub/funcs/partnersUpdateSale.js";
...
async function run() {
  const res = await partnersUpdateSale(dub);
...
**Promise\<[operations.UpdatePartnerSaleResponseBody](../../models/operations/updatepartnersaleresponsebody.md)\>**
