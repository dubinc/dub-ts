...
<!-- UsageSnippet language="typescript" operationID="approvePartner" method="post" path="/partners/applications/approve" -->
```typescript
import { Dub } from "dub";
...
**Promise\<[operations.ApprovePartnerResponseBody](../../models/operations/approvepartnerresponsebody.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="rejectPartner" method="post" path="/partners/applications/reject" -->
```typescript
import { Dub } from "dub";
...
**Promise\<[operations.RejectPartnerResponseBody](../../models/operations/rejectpartnerresponsebody.md)\>**
