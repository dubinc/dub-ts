...
import { commissionsList } from "dub/funcs/commissionsList.js";
...
**Promise\<[operations.ListCommissionsResponse](../../models/operations/listcommissionsresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="createCommission" method="post" path="/commissions" -->
```typescript
import { Dub } from "dub";
...
```typescript
import { DubCore } from "dub/core.js";
import { commissionsCreate } from "dub/funcs/commissionsCreate.js";
...
async function run() {
  const res = await commissionsCreate(dub);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("commissionsCreate failed:", res.error);
  }
}
...
**Promise\<[operations.CreateCommissionResponseBody](../../models/operations/createcommissionresponsebody.md)\>**
...
```typescript
import { DubCore } from "dub/core.js";
import { commissionsUpdate } from "dub/funcs/commissionsUpdate.js";
...
**Promise\<[operations.UpdateCommissionResponseBody](../../models/operations/updatecommissionresponsebody.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="bulkUpdateCommissions" method="patch" path="/commissions/bulk" -->
```typescript
import { Dub } from "dub";
...
```typescript
import { DubCore } from "dub/core.js";
import { commissionsUpdateMany } from "dub/funcs/commissionsUpdateMany.js";
...
async function run() {
  const res = await commissionsUpdateMany(dub);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("commissionsUpdateMany failed:", res.error);
  }
}
...
**Promise\<[operations.BulkUpdateCommissionsResponseBody[]](../../models/.md)\>**
