...
<!-- UsageSnippet language="typescript" operationID="listDiscountCodes" method="get" path="/discount-codes" -->
```typescript
import { Dub } from "dub";
...
**Promise\<[components.DiscountCodeSchema[]](../../models/.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="createDiscountCode" method="post" path="/discount-codes" -->
```typescript
import { Dub } from "dub";
...
**Promise\<[components.DiscountCodeSchema](../../models/components/discountcodeschema.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="deleteDiscountCode" method="delete" path="/discount-codes/{idOrCode}" -->
```typescript
import { Dub } from "dub";
...
**Promise\<[operations.DeleteDiscountCodeResponseBody](../../models/operations/deletediscountcoderesponsebody.md)\>**
